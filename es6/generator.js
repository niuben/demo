...
var createIterator2 = function * () {
    var content1 = yield readFile2('content1')
    var content2 = yield readFile2('content2')
    console.log(content1)
    console.log(content2)
}

function runPromiseTask(func) {
    var task = func();
    var result = task.next();
...
runPromiseTask(createIterator2);